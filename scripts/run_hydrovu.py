...
def main():
    ...
    parser.add_argument("-start", type=str, help="Start time in ISO format (e.g., 2025-01-01T00:00:00Z)")
    parser.add_argument("-end", type=str, help="End time in ISO format (e.g., 2025-01-02T00:00:00Z)")
